...
name: ponytail-think
description: >
  Reasoning-first companion to ponytail: think the problem through out loud,
  weigh the real options with their costs, then hand back one clear, justified
  solution. Where plain ponytail ships code plus at most three lines, this
  mode surfaces the "why" before the code. Use when the user says "think it
  through", "explain your reasoning", "walk me through the options", "why
  this approach", "give me a clear solution", "ponytail-think", or invokes
  /ponytail-think.
license: MIT
---
